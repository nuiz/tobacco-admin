...
(function (factory) {
    ...
    $.extend(Gallery.prototype.options, {
        // The class for media content elements:
        videoContentClass: 'media-content',
        // The class for media when it is loading:
        videoLoadingClass: 'media-loading',
        // The class for media when it is playing:
        videoPlayingClass: 'media-playing',
        // The list object property (or data attribute) for the media poster URL:
        videoPosterProperty: 'poster',
        // The list object property (or data attribute) for the media sources array:
