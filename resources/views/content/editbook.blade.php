            ...
            <div class="widget-body innerAll inner-2x">
                <form class="form-horizontal" id="addebook-form" role="form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="boon_author" class="form-control" placeholder="ชื่อผู้แต่ง" value="<?php echo $content->book_author;?>">
                        </div>
                    </div>
                    <div class="form-group">
    ...
    <script>
        $(function(){
            ...
            for(i=0;i<tree.data.length;i++){
                $rootSelect.append('<option '+((cat_id==tree.data[i].category_id)? 'selected': '') +' value="'+tree.data[i].category_id+'">'+tree.data[i].category_name+'</option>');
            }
