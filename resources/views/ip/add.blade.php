            ...
            <div class="widget-body innerAll inner-2x">
                <form enctype="multipart/form-data" class="form-horizontal" id="addnews-form" role="form" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea type="text" id="ip" name="ip" class="form-control" placeholder="" required=""></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                ...
                $.ajax({
                    ...
                    success: function(data){
                        if(data.error == undefined){
                            ...
                            setTimeout(function(){ window.location.replace('<?php echo URL::to("ip");?>'); }, 1000);
                        }
                        else {
                            notyfy({
                                text: 'No success',
